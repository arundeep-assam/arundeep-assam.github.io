!function(e, t) {
    ...
    function x(e, t, n, r) {
        ...
        , u = s(), c = n && n[3] || (ke.cssNumber[t] ? "" : "px"), l = e.nodeType && (ke.cssNumber[t] || "px" !== c && +u) && Ze.exec(ke.css(e, t));
        if (l && l[3] !== c) {
            for (u /= 2,
            c = c || l[3],
            l = +u || 1; a--; )
    ...
    function w(e, t) {
        for (var n, r, i = [], o = 0, a = e.length; o < a; o++)
            ...
            t ? ("none" === n && (i[o] = Ge.get(r, "display") || null,
            i[o] || (r.style.display = "")),
            "" === r.style.display && it(r) && (i[o] = b(r))) : "none" !== n && (i[o] = "none",
            Ge.set(r, "display", n)));
        for (o = 0; o < a; o++)
        ...
        ke.event.add(e, t, {
            ...
            handler: function(e) {
                ...
                if (1 & e.isTrigger && this[t]) {
                    ...
                    r && (Ge.set(this, t, ke.event.trigger(r[0], r.slice(1), this)),
                    e.stopPropagation(),
    ...
    function q(e, t) {
        ...
        if (1 === t.nodeType) {
            if (Ge.hasData(e) && (s = Ge.get(e).events))
                for (i in Ge.remove(t, "handle events"),
                s)
                    for (n = 0,
                    r = s[i].length; n < r; n++)
                        ke.event.add(t, i, s[i][n]);
            Je.hasData(e) && (o = Je.access(e),
            a = ke.extend({}, o),
            Je.set(t, a))
        }
    }
    ...
    function O(e, t, r, i) {
        t = ce(t);
        var o, a, s, u, c, l, f = 0, p = e.length, d = p - 1, h = t[0], g = me(h);
        ...
        if (p && (a = (o = k(t, e[0].ownerDocument, !1, e, i)).firstChild,
        1 === o.childNodes.length && (o = a),
        a || i)) {
            for (u = (s = ke.map(T(o, "script"), N)).length; f < p; f++)
                c = o,
                f !== d && (c = ke.clone(c, !0, !0),
                u && ke.merge(s, T(c, "script"))),
                r.call(e[f], c, f);
            if (u)
                ...
                f = 0; f < u; f++)
                    c = s[f],
                    lt.test(c.type || "") && !Ge.access(c, "globalEval") && ke.contains(l, c) && (c.src && "module" !== (c.type || "").toLowerCase() ? ke._evalUrl && !c.noModule && ke._evalUrl(c.src, {
    ...
    function P(e, t, n) {
        for (var r, i = t ? ke.filter(t, e) : e, o = 0; null != (r = i[o]); o++)
            ...
            r.parentNode && (n && nt(r) && C(T(r, "script")),
            r.parentNode.removeChild(r));
        return e
    }
    function M(e, t, n) {
        var r, i, o, a, s = mt.test(t), u = e.style;
        return (n = n || xt(e)) && (a = n.getPropertyValue(t) || n[t],
        s && a && (a = a.replace(De, "$1") || void 0),
        "" !== a || nt(e) || (a = ke.style(e, t)),
        !ye.pixelBoxStyles() && yt.test(a) && wt.test(t) && (r = u.width,
        i = u.minWidth,
        o = u.maxWidth,
    ...
    function W(e, t, n, r, i, o) {
        ...
        for (; a < 4; a += 2)
            ...
            r ? ("content" === n && (u -= ke.css(e, "padding" + et[a], !0, i)),
            "margin" !== n && (u -= ke.css(e, "border" + et[a] + "Width", !0, i))) : (u += ke.css(e, "padding" + et[a], !0, i),
            "padding" !== n ? u += ke.css(e, "border" + et[a] + "Width", !0, i) : s += ke.css(e, "border" + et[a] + "Width", !0, i));
    ...
    function _(e, t, n) {
        ...
        return (!ye.boxSizingReliable() && i || !ye.reliableTrDimensions() && o(e, "tr") || "auto" === s || !parseFloat(s) && "inline" === ke.css(e, "display", !1, r)) && e.getClientRects().length && (i = "border-box" === ke.css(e, "boxSizing", !1, r),
        (a = u in e) && (s = e[u])),
    ...
    function U() {
        Dt && (!1 === be.hidden && e.requestAnimationFrame ? e.requestAnimationFrame(U) : e.setTimeout(U, ke.fx.interval),
        ke.fx.tick())
    }
    function z() {
    ...
    function G(e, t, n) {
        var r, i, o, a, s, u, c, l, f = "width"in t || "height"in t, p = this, d = {}, h = e.style, g = e.nodeType && it(e), v = Ge.get(e, "fxshow");
        ...
        if ((u = !ke.isEmptyObject(t)) || !ke.isEmptyObject(d))
            ...
            "none" === (l = ke.css(e, "display")) && (c ? l = c : (w([e], !0),
            c = e.style.display || c,
            l = ke.css(e, "display"),
            w([e]))),
            ("inline" === l || "inline-block" === l && null != c) && "none" === ke.css(e, "float") && (u || (p.done((function() {
                h.display = c
            }
            )),
            null == c && (l = h.display,
            ...
            u = !1,
            d)
                u || (v ? "hidden"in v && (g = v.hidden) : v = Ge.access(e, "fxshow", {
                    display: c
                }),
                o && (v.hidden = !g),
                g && w([e], !0),
    ...
    function Q(e, t, n) {
        var r, i, o = 0, a = Q.prefilters.length, s = ke.Deferred().always((function() {
            delete u.elem
        }
        )), u = function() {
            if (i)
                return !1;
            for (var t = At || z(), n = Math.max(0, c.startTime + c.duration - t), r = 1 - (n / c.duration || 0), o = 0, a = c.tweens.length; o < a; o++)
                c.tweens[o].run(r);
        ...
        for (J(l, c.opts.specialEasing); o < a; o++)
            if (r = Q.prefilters[o].call(c, e, l, c.opts))
                return me(r.stop) && (ke._queueHooks(c.elem, c.opts.queue).stop = r.stop.bind(r)),
                r;
        return ke.map(l, V, c),
    ...
    ke.extend = ke.fn.extend = function() {
        ...
        s--); s < u; s++)
            if (null != (e = arguments[s]))
                for (t in e)
                    r = e[t],
                    "__proto__" !== t && a !== r && (c && r && (ke.isPlainObject(r) || (i = Array.isArray(r))) ? (n = a[t],
                    o = i && !Array.isArray(n) ? [] : i || ke.isPlainObject(n) ? n : {},
                    i = !1,
    ...
    ke.extend({
        ...
        makeArray: function(e, t) {
            var n = t || [];
            return null != e && (i(Object(e)) ? ke.merge(n, "string" == typeof e ? [e] : e) : le.call(n, e)),
            n
        },
    ...
    "function" == typeof Symbol && (ke.fn[Symbol.iterator] = ae[Symbol.iterator]),
    ...
    !function() {
        ...
        function n(e, t, r, i) {
            var o, a, s, u, c, l, d, v = t && t.ownerDocument, y = t ? t.nodeType : 9;
            if (r = r || [],
            ...
            q)) {
                ...
                if (!(_[e + " "] || H && H.test(e))) {
                    if (d = e,
                    v = t,
                    1 === y && (Y.test(e) || Q.test(e))) {
                        for ((v = ie.test(e) && f(t.parentNode) || t) == t && ye.scope || ((u = t.getAttribute("id")) ? u = ke.escapeSelector(u) : t.setAttribute("id", u = M)),
                        a = (l = h(e)).length; a--; )
                            l[a] = (u ? "#" + u : ":scope") + " " + g(l[a]);
                        d = l.join(",")
                    }
        ...
        function p(e) {
            ...
            return r != N && 9 === r.nodeType && r.documentElement ? (L = (N = r).documentElement,
            q = !ke.isXMLDoc(N),
            O = L.matches || L.webkitMatchesSelector || L.msMatchesSelector,
            L.msMatchesSelector && Le != N && (t = N.defaultView) && t.top !== t && t.addEventListener("unload", ce),
            ye.getById = a((function(e) {
                return L.appendChild(e).id = ke.expando,
            ...
            a((function(e) {
                ...
                e.querySelectorAll("[selected]").length || H.push("\\[" + Ae + "*(?:value|" + U + ")"),
        ...
        function h(e, t) {
            ...
            u = [],
            c = E.preFilter; s; ) {
                for (a in r && !(i = J.exec(s)) || (i && (s = s.slice(i[0].length) || s),
                u.push(o = [])),
                r = !1,
                ...
                s = s.slice(r.length)),
                E.filter)
                    !(i = ee[a].exec(s)) || c[a] && !(i = c[a](i)) || (r = i.shift(),
                    o.push({
                        value: r,
                        type: a,
                        matches: i
        ...
        function b(e, t, n, r, o, a) {
            ...
            o && !o[M] && (o = b(o, a)),
            i((function(i, a, s, u) {
                var c, l, f, p, d = [], h = [], g = a.length, v = i || m(t || "*", s.nodeType ? [s] : s, []), y = !e || !i && t ? v : x(v, d, e, s, u);
                if (n ? n(y, p = o || (i ? e : g || r) ? [] : a, s, u) : p = y,
                r)
                    for (c = x(p, h),
                    r(c, [], s, u),
                    l = c.length; l--; )
                ...
                if (i) {
                    if (o || e) {
                        ...
                        for (l = p.length; l--; )
                            (f = p[l]) && (c = o ? fe.call(i, f) : d[l]) > -1 && (i[c] = !(a[c] = f))
                    }
                } else
        ...
        function T(e, t) {
            var n = t.length > 0
              ...
              , o = function(i, o, a, s, u) {
                var c, l, f, d = 0, h = "0", g = i && [], v = [], y = j, m = i || r && E.find.TAG("*", u), b = R += null == y ? 1 : Math.random() || .1, w = m.length;
                for (u && (j = o == N || o || u); h !== w && null != (c = m[h]); h++) {
                    if (r && c) {
                        for (l = 0,
                        o || c.ownerDocument == N || (p(c),
                        a = !q); f = e[l++]; )
                            if (f(c, o || N, a)) {
                                P.call(s, c);
                                break
        ...
        function k(e, t, n, r) {
            ...
            return (c || C(e, l))(r, t, !q, n, !t || ie.test(e) && f(t.parentNode) || t),
            n
        }
        var S, E, j, A, D, N, L, q, H, O, P = qe, M = ke.expando, R = 0, I = 0, F = r(), $ = r(), W = r(), _ = r(), B = function(e, t) {
            return e === t && (D = !0),
            0
        }, U = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", z = "(?:\\\\[\\da-fA-F]{1,6}" + Ae + "?|\\\\[^\\r\\n\\f]|[\\w-]|[^\0-\\x7f])+", X = "\\[" + Ae + "*(" + z + ")(?:" + Ae + "*([*^$|!~]?=)" + Ae + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + z + "))|)" + Ae + "*\\]", V = ":(" + z + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + X + ")*)|.*)\\)|)", G = new RegExp(Ae + "+","g"), J = new RegExp("^" + Ae + "*," + Ae + "*"), Q = new RegExp("^" + Ae + "*([>+~]|" + Ae + ")" + Ae + "*"), Y = new RegExp(Ae + "|>"), K = new RegExp(V), Z = new RegExp("^" + z + "$"), ee = {
            ID: new RegExp("^#(" + z + ")"),
            CLASS: new RegExp("^\\.(" + z + ")"),
            TAG: new RegExp("^(" + z + "|[*])"),
            ATTR: new RegExp("^" + X),
        ...
        E = ke.expr = {
            ...
            filter: {
                ...
                CHILD: function(e, t, n, r, i) {
                    ...
                    : function(t, n, c) {
                        var l, f, p, d, h, g = a !== s ? "nextSibling" : "previousSibling", v = t.parentNode, y = u && t.nodeName.toLowerCase(), m = !c && !u, x = !1;
                        if (v) {
                            if (a) {
                                for (; g; ) {
                                    for (p = t; p = p[g]; )
                            ...
                            s && m) {
                                for (x = (d = (l = (f = v[M] || (v[M] = {}))[e] || [])[0] === R && l[1]) && l[2],
                                p = d && v.childNodes[d]; p = ++d && p && p[g] || (x = d = 0) || h.pop(); )
                                    if (1 === p.nodeType && ++x && p === t) {
                                        f[e] = [R, d, x];
                                        break
                                    }
                            } else if (m && (x = d = (l = (f = t[M] || (t[M] = {}))[e] || [])[0] === R && l[1]),
                            !1 === x)
                                for (; (p = ++d && p && p[g] || (x = d = 0) || h.pop()) && (!(u ? o(p, y) : 1 === p.nodeType) || !++x || (m && ((f = p[M] || (p[M] = {}))[e] = [R, x]),
                                p !== t)); )
                                    ;
                ...
                PSEUDO: function(e, t) {
                    ...
                    return o[M] ? o(t) : o.length > 1 ? (r = [e, e, "", t],
                    E.setFilters.hasOwnProperty(e.toLowerCase()) ? i((function(e, n) {
    ...
    (ke.fn.init = function(e, t, n) {
        ...
        "string" == typeof e) {
            ...
            if (r[1]) {
                ...
                ke.merge(this, ke.parseHTML(r[1], t && t.nodeType ? t.ownerDocument || t : be, !0)),
                Me.test(r[1]) && ke.isPlainObject(t))
                    for (r in t)
                        me(this[r]) ? this[r](t[r]) : this.attr(r, t[r]);
                return this
            }
            return (i = be.getElementById(r[2])) && (this[0] = i,
            this.length = 1),
            this
        }
        return e.nodeType ? (this[0] = e,
        this.length = 1,
        this) : me(e) ? void 0 !== n.ready ? n.ready(e) : e(ke) : ke.makeArray(e, this)
    }
    ).prototype = ke.fn,
    Re = ke(be);
    ...
    ke.each({
        ...
        ke.fn[e] = function(n, r) {
            ...
            this.length > 1 && ($e[e] || ke.uniqueSort(i),
            Fe.test(e) && i.reverse()),
            this.pushStack(i)
        }
    }
                ...
                then: function(t, r, i) {
                    function o(t, n, r, i) {
                        return function() {
                            var s = this
                              ...
                              , c = function() {
                                ...
                                if (!(t < a)) {
                                    ...
                                    me(c) ? i ? c.call(e, o(a, n, l, i), o(a, n, f, i)) : (a++,
                                    c.call(e, o(a, n, l, i), o(a, n, f, i), o(a, n, l, n.notifyWith))) : (r !== l && (s = void 0,
                                    u = [e]),
                                    (i || n.resolveWith)(s, u))
                                }
                            }
                              , p = i ? c : function() {
                                try {
                                    ...
                                    ke.Deferred.exceptionHook && ke.Deferred.exceptionHook(e, p.error),
                                    t + 1 >= a && (r !== f && (s = void 0,
                                    u = [e]),
                                    n.rejectWith(s, u))
                                }
                            ...
                            ;
                            t ? p() : (ke.Deferred.getErrorHook ? p.error = ke.Deferred.getErrorHook() : ke.Deferred.getStackHook && (p.error = ke.Deferred.getStackHook()),
                            e.setTimeout(p))
                        }
                    }
                    var a = 0;
    ...
    "complete" === be.readyState || "loading" !== be.readyState && !be.documentElement.doScroll ? e.setTimeout(ke.ready) : (be.addEventListener("DOMContentLoaded", d),
    ...
    ke.fn.extend({
        data: function(e, t) {
            ...
            return "object" == typeof e ? this.each((function() {
                ...
                var n;
                if (o && void 0 === t)
                    return void 0 !== (n = Je.get(o, e)) || void 0 !== (n = m(o, e)) ? n : void 0;
                this.each((function() {
                    Je.set(this, e, t)
                }
                ))
    ...
    ke.extend({
        queue: function(e, t, n) {
            ...
            if (e)
                return t = (t || "fx") + "queue",
                r = Ge.get(e, t),
                n && (!r || Array.isArray(n) ? r = Ge.access(e, t, ke.makeArray(n)) : r.push(n)),
                r || []
        },
    ...
    ft.th = ft.td,
    ye.option || (ft.optgroup = ft.option = [1, "<select multiple='multiple'>", "</select>"]);
    var pt = /<|&#?\w+;/
      , dt = /^([^.]*)(?:\.(.+)|)/;
    ke.event = {
        global: {},
        add: function(e, t, n, r, i) {
            ...
            if (Ve(e))
                ...
                c = (t = (t || "").match(We) || [""]).length; c--; )
                    d = g = (s = dt.exec(t[c]) || [])[1],
                    h = (s[2] || "").split(".").sort(),
                    d && (f = ke.event.special[d] || {},
        ...
        remove: function(e, t, n, r, i) {
            ...
            if (v && (u = v.events)) {
                for (c = (t = (t || "").match(We) || [""]).length; c--; )
                    if (d = g = (s = dt.exec(t[c]) || [])[1],
                    h = (s[2] || "").split(".").sort(),
                    d) {
                        for (f = ke.event.special[d] || {},
                        ...
                        for (d in u)
                            ke.event.remove(e, d + t[c], n, r, !0);
                ke.isEmptyObject(u) && Ge.remove(e, "handle events")
            }
        },
        dispatch: function(e) {
            var t, n, r, i, o, a, s = new Array(arguments.length), u = ke.event.fix(e), c = (Ge.get(this, "events") || Object.create(null))[u.type] || [], l = ke.event.special[u.type] || {};
            for (s[0] = u,
            t = 1; t < arguments.length; t++)
                s[t] = arguments[t];
            if (u.delegateTarget = this,
            !l.preDispatch || !1 !== l.preDispatch.call(this, u)) {
                for (a = ke.event.handlers.call(this, u, c),
                t = 0; (i = a[t++]) && !u.isPropagationStopped(); )
                    ...
                    n = 0; (o = i.handlers[n++]) && !u.isImmediatePropagationStopped(); )
                        ...
                        u.data = o.data,
                        void 0 !== (r = ((ke.event.special[o.origType] || {}).handle || o.handler).apply(i.elem, s)) && !1 === (u.result = r) && (u.preventDefault(),
                        u.stopPropagation()));
            ...
            if (u && c.nodeType && !("click" === e.type && e.button >= 1))
                for (; c !== this; c = c.parentNode || this)
                    if (1 === c.nodeType && ("click" !== e.type || !0 !== c.disabled)) {
                        ...
                        a = {},
                        n = 0; n < u; n++)
                            void 0 === a[i = (r = t[n]).selector + " "] && (a[i] = r.needsContext ? ke(i, this).index(c) > -1 : ke.find(i, this, null, [c]).length),
                            a[i] && o.push(r);
                        o.length && s.push({
                            elem: c,
                            handlers: o
        ...
        special: {
            ...
            click: {
                ...
                trigger: function(e) {
                    var t = this || e;
                    return ut.test(t.type) && t.click && o(t, "input") && A(t, "click"),
                    !0
                },
                _default: function(e) {
                    var t = e.target;
    ...
    ke.Event = function(e, t) {
        ...
        this.type = e.type,
        this.isDefaultPrevented = e.defaultPrevented || void 0 === e.defaultPrevented && !1 === e.returnValue ? S : E,
    ...
    ke.each({
        ...
        ke.event.special[e] = {
            ...
            teardown: function() {
                ...
                if (!be.documentMode)
                    return !1;
                (e = Ge.get(this, t) - 1) ? Ge.set(this, t, e) : (this.removeEventListener(t, n),
                Ge.remove(this, t))
            },
            _default: function(t) {
        ...
        ke.event.special[t] = {
            ...
            teardown: function() {
                var r = this.ownerDocument || this.document || this
                  , i = be.documentMode ? this : r
                  , o = Ge.get(i, t) - 1;
                o ? Ge.set(i, t, o) : (be.documentMode ? this.removeEventListener(t, n) : r.removeEventListener(e, n, !0),
                Ge.remove(i, t))
            }
        }
    }
    ...
    ke.each({
        ...
        ke.event.special[e] = {
            ...
            handle: function(e) {
                ...
                return i && (i === r || ke.contains(r, i)) || (e.type = o.origType,
        ...
        clone: function(e, t, n) {
            ...
            if (t)
                if (n)
                    ...
                    q(e, s);
            return (a = T(s, "script")).length > 0 && C(a, !u && T(e, "script")),
            s
        },
    ...
    ke.fn.extend({
        ...
        empty: function() {
            for (var e, t = 0; null != (e = this[t]); t++)
                1 === e.nodeType && (ke.cleanData(T(e, !1)),
                e.textContent = "");
            return this
        },
        clone: function(e, t) {
        ...
        html: function(e) {
            return Ue(this, (function(e) {
                ...
                if ("string" == typeof e && !ht.test(e) && !ft[(ct.exec(e) || ["", ""])[1].toLowerCase()]) {
                    ...
                    try {
                        for (; n < r; n++)
                            1 === (t = this[n] || {}).nodeType && (ke.cleanData(T(t, !1)),
                            t.innerHTML = e);
                        t = 0
                    } catch (e) {}
                }
        ...
        replaceWith: function() {
            ...
            return O(this, arguments, (function(t) {
                ...
                ke.inArray(this, e) < 0 && (ke.cleanData(T(this)),
    ...
    !function() {
        ...
        var r, i, o, a, s, u, c = be.createElement("div"), l = be.createElement("div");
    ...
    ke.extend({
        ...
        style: function(e, t, n, r) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var i, o, a, s = g(t), u = mt.test(t), c = e.style;
                if (u || (t = F(s)),
                a = ke.cssHooks[t] || ke.cssHooks[s],
                void 0 === n)
                    return a && "get"in a && void 0 !== (i = a.get(e, !1, r)) ? i : c[t];
                "string" === (o = typeof n) && (i = Ze.exec(n)) && i[1] && (n = x(e, t, i),
                o = "number"),
    ...
    ke.each(["height", "width"], (function(e, t) {
        ke.cssHooks[t] = {
            get: function(e, n, r) {
                if (n)
                    return !St.test(ke.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? _(e, t, r) : bt(e, Et, (function() {
                        return _(e, t, r)
                    }
                    ))
            },
            set: function(e, n, r) {
                var i, o = xt(e), a = !ye.scrollboxSize() && "absolute" === o.position, s = (a || r) && "border-box" === ke.css(e, "boxSizing", !1, o), u = r ? W(e, t, r, s, o) : 0;
                return s && a && (u -= Math.ceil(e["offset" + t[0].toUpperCase() + t.slice(1)] - parseFloat(o[t]) - W(e, t, "border", !1, o) - .5)),
                u && (i = Ze.exec(n)) && "px" !== (i[3] || "px") && (e.style[t] = n,
                n = ke.css(e, t)),
                $(e, n, u)
            }
        }
    ...
    ke.cssHooks.marginLeft = R(ye.reliableMarginLeft, (function(e, t) {
        if (t)
            return (parseFloat(M(e, "marginLeft")) || e.getBoundingClientRect().left - bt(e, {
                marginLeft: 0
            }, (function() {
    ...
    ke.fx.step = {};
    var At, Dt, Nt = /^(?:toggle|show|hide)$/, Lt = /queueHooks$/;
    ke.Animation = ke.extend(Q, {
        tweeners: {
            "*": [function(e, t) {
                var n = this.createTween(e, t);
                return x(n.elem, e, Ze.exec(t), n),
                n
            }
            ]
        },
    ...
    ke.fn.extend({
        ...
        finish: function(e) {
            return !1 !== e && (e = e || "fx"),
            this.each((function() {
                var t, n = Ge.get(this), r = n[e + "queue"], i = n[e + "queueHooks"], o = ke.timers, a = r ? r.length : 0;
                for (n.finish = !0,
                ke.queue(this, e, []),
    ...
    ke.fn.delay = function(t, n) {
        return t = ke.fx && ke.fx.speeds[t] || t,
        n = n || "fx",
    ...
    ke.extend({
        attr: function(e, t, n) {
            ...
            if (3 !== o && 8 !== o && 2 !== o)
                return void 0 === e.getAttribute ? ke.prop(e, t, n) : (1 === o && ke.isXMLDoc(e) || (i = ke.attrHooks[t.toLowerCase()] || (ke.expr.match.bool.test(t) ? qt : void 0)),
                void 0 !== n ? null === n ? void ke.removeAttr(e, t) : i && "set"in i && void 0 !== (r = i.set(e, n, t)) ? r : (e.setAttribute(t, n + ""),
                n) : i && "get"in i && null !== (r = i.get(e, t)) ? r : null == (r = ke.find.attr(e, t)) ? void 0 : r)
        },
        attrHooks: {
            type: {
                set: function(e, t) {
        ...
        toggleClass: function(e, t) {
            ...
            this.each((function() {
                if (s)
                    ...
                    void 0 !== e && "boolean" !== a || ((r = K(this)) && Ge.set(this, "__className__", r),
                    this.setAttribute && this.setAttribute("class", r || !1 === e ? "" : Ge.get(this, "__className__") || ""))
            }
            )))
        },
        hasClass: function(e) {
            ...
            select: {
                ...
                set: function(e, t) {
                    for (var n, r, i = e.options, o = ke.makeArray(t), a = i.length; a--; )
                        ((r = i[a]).selected = ke.inArray(ke.valHooks.option.get(r), o) > -1) && (n = !0);
    ...
    ke.parseXML = function(t) {
        ...
        n && !r || ke.error("Invalid XML: " + (r ? ke.map(r.childNodes, (function(e) {
    ...
    ke.extend(ke.event, {
        trigger: function(t, n, r, i) {
            var o, a, s, u, c, l, f, p, d = [r || be], h = he.call(t, "type") ? t.type : t, g = he.call(t, "namespace") ? t.namespace.split(".") : [];
            if (a = p = s = r = r || be,
            3 !== r.nodeType && 8 !== r.nodeType && !$t.test(h + ke.event.triggered) && (h.indexOf(".") > -1 && (g = h.split("."),
            h = g.shift(),
            g.sort()),
            c = h.indexOf(":") < 0 && "on" + h,
            (t = t[ke.expando] ? t : new ke.Event(h,"object" == typeof t && t)).isTrigger = i ? 2 : 3,
            t.namespace = g.join("."),
            ...
            i || !f.trigger || !1 !== f.trigger.apply(r, n))) {
                if (!i && !f.noBubble && !xe(r)) {
                    ...
                    $t.test(u + h) || (a = a.parentNode); a; a = a.parentNode)
                        d.push(a),
                        s = a;
                ...
                for (o = 0; (a = d[o++]) && !t.isPropagationStopped(); )
                    ...
                    (l = (Ge.get(a, "events") || Object.create(null))[t.type] && Ge.get(a, "handle")) && l.apply(a, n),
                    (l = c && a[c]) && l.apply && Ve(a) && (t.result = l.apply(a, n),
                    !1 === t.result && t.preventDefault());
                return t.type = h,
                i || t.isDefaultPrevented() || f._default && !1 !== f._default.apply(d.pop(), n) || !Ve(r) || c && me(r[h]) && !xe(r) && ((s = r[c]) && (r[c] = null),
    ...
    ke.extend({
        ...
        ajax: function(t, n) {
            function r(t, n, r, s) {
                ...
                c = t >= 200 && t < 300 || 304 === t,
                r && (b = ie(h, C, r)),
                !c && ke.inArray("script", h.dataTypes) > -1 && ke.inArray("json", h.dataTypes) < 0 && (h.converters["text script"] = function() {}
                ),
                b = oe(h, b, C, c),
                c ? (h.ifModified && ((w = C.getResponseHeader("Last-Modified")) && (ke.lastModified[o] = w),
            ...
            t = void 0),
            n = n || {};
            var i, o, a, s, u, c, l, f, p, d, h = ke.ajaxSetup({}, n), g = h.context || h, v = h.context && (g.nodeType || g.jquery) ? ke(g) : ke.event, y = ke.Deferred(), m = ke.Callbacks("once memory"), x = h.statusCode || {}, b = {}, w = {}, T = "canceled", C = {
                readyState: 0,
            ...
            if (y.promise(C),
            h.url = ((t || h.url || Rt.href) + "").replace(Kt, Rt.protocol + "//"),
            ...
            null == h.crossDomain) {
                ...
                try {
                    c.href = h.url,
                    c.href = c.href,
                    h.crossDomain = nn.protocol + "//" + nn.host != c.protocol + "//" + c.host
                } catch (e) {
                    h.crossDomain = !0
                }
            }
            ...
            l)
                return C;
            for (p in (f = ke.event && h.global) && 0 == ke.active++ && ke.event.trigger("ajaxStart"),
            h.type = h.type.toUpperCase(),
            h.hasContent = !Yt.test(h.type),
            o = h.url.replace(Vt, ""),
            h.hasContent ? h.data && h.processData && 0 === (h.contentType || "").indexOf("application/x-www-form-urlencoded") && (h.data = h.data.replace(Xt, "+")) : (d = h.url.slice(o.length),
            h.data && (h.processData || "string" == typeof h.data) && (o += (Ft.test(o) ? "&" : "?") + h.data,
            delete h.data),
            !1 === h.cache && (o = o.replace(Gt, "$1"),
            d = (Ft.test(o) ? "&" : "?") + "_=" + It.guid++ + d),
            h.url = o + d),
            h.ifModified && (ke.lastModified[o] && C.setRequestHeader("If-Modified-Since", ke.lastModified[o]),
            ...
            C.setRequestHeader("Accept", h.dataTypes[0] && h.accepts[h.dataTypes[0]] ? h.accepts[h.dataTypes[0]] + ("*" !== h.dataTypes[0] ? ", " + tn + "; q=0.01" : "") : h.accepts["*"]),
            h.headers)
    ...
    ke.ajaxPrefilter("json jsonp", (function(t, n, r) {
        ...
        if (s || "jsonp" === t.dataTypes[0])
            ...
            s ? t[s] = t[s].replace(un, "$1" + i) : !1 !== t.jsonp && (t.url += (Ft.test(t.url) ? "&" : "?") + t.jsonp + "=" + i),
            t.converters["script json"] = function() {
                return a || ke.error(i + " was not called"),
                a[0]
            }
            ,
            t.dataTypes[0] = "json",
    ...
    ye.createHTMLDocument = ((an = be.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>",
    2 === an.childNodes.length),
    ke.parseHTML = function(e, t, n) {
        return "string" != typeof e ? [] : ("boolean" == typeof t && (n = t,
        t = !1),
        t || (ye.createHTMLDocument ? ((r = (t = be.implementation.createHTMLDocument("")).createElement("base")).href = be.location.href,
        t.head.appendChild(r)) : t = be),
        o = !n && [],
        (i = Me.exec(e)) ? [t.createElement(i[1])] : (i = k([e], t, o),
    ...
    ke.each(["top", "left"], (function(e, t) {
        ke.cssHooks[t] = R(ye.pixelPosition, (function(e, n) {
            if (n)
                return n = M(e, t),
                yt.test(n) ? ke(e).position()[t] + "px" : n
        }
        ))
    }
    )),
...
Views.AffiliatesTracker = class {
    constructor() {
        ...
        (0,
        Market.Helpers.CookieConsent.given)("necessary") && e()
    }
    registerReferral() {
